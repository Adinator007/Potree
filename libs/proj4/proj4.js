!(function (t, s) {
  ...
  function s(t, s) {
    if (t[s]) return t[s];
    for (
      var i, a = Object.keys(t), h = s.toLowerCase().replace(Mt, ""), e = -1;
      ++e < a.length;
  ...
  function L(t) {
    ...
    a = t.substring(e, (e += 2));
    for (var o = O(n), l = B(a.charAt(0), o), M = T(a.charAt(1), o); M < F(r); )
      M += 2e6;
    var c = i - e;
    if (c % 2 != 0)
      throw (
    ...
    vt = [
      {
        ...
        forward: function (t) {
          var s = t.x,
            i = t.y;
          if (i * ht > 90 && i * ht < -90 && s * ht > 180 && s * ht < -180)
            return null;
          var a, h;
          ...
          if (this.sphere)
            (a = this.x0 + this.a * this.k0 * dt(s - this.long0)),
              (h =
                this.y0 + this.a * this.k0 * Math.log(Math.tan(et + 0.5 * i)));
          else {
            var e = Math.sin(i),
              n = _t(this.e, i, e);
            (a = this.x0 + this.a * this.k0 * dt(s - this.long0)),
        ...
        inverse: function (t) {
          var s,
            ...
            h = t.y - this.y0;
          if (this.sphere)
            i = Y - 2 * Math.atan(Math.exp(-h / (this.a * this.k0)));
          else {
  ...
  var Ft = 0.01068115234375,
    ...
    Ut = {
      ...
      forward: function (t) {
        ...
        if (this.es) {
          ...
          if (
            ((i =
              0.5 * this.a * this.k0 * Math.log((1 + d) / (1 - d)) + this.x0),
    ...
    ss = function (t, s) {
      if (void 0 === t) {
        if ((t = Math.floor((30 * (dt(s) + Math.PI)) / Math.PI) + 1) < 0)
          return 0;
        if (t > 60) return 60;
      }
      return t;
    ...
    es = {
      ...
      inverse: function (t) {
        for (
          ...
          h > 0 &&
          ((i =
            2 * Math.atan(a * as(this.e * Math.sin(t.y), -0.5 * this.e)) - Y),
    ...
    rs = {
            ...
            : (Math.abs(this.coslat0) <= it &&
              ...
              1 === this.k0 &&
                ...
                (this.k0 =
                  (0.5 *
                    this.cons *
                    pt(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts))) /
                  _t(
                    this.e,
              ...
              (this.X0 =
                2 * Math.atan(this.ssfn_(this.lat0, this.sinlat0, this.e)) - Y),
      ...
      inverse: function (t) {
        ...
        if (Math.abs(this.coslat0) <= it) {
          ...
          (t.x *= this.con),
            ...
            (s =
              this.con * dt(this.con * this.long0 + Math.atan2(t.x, -1 * t.y)));
        } else
          (h =
            2 *
      ...
      ssfn_: function (t, s, i) {
        return (
          (s *= i),
          Math.tan(0.5 * (Y + t)) * Math.pow((1 - s) / (1 + s), 0.5 * i)
        );
      },
    },
    os = {
          ...
          if (
            ...
            if (
              (i =
                this.mode === this.EQUIT
                  ? 1 + M * a
                  : 1 + this.sinph0 * e + this.cosph0 * M * a) <= it
            )
              return null;
      ...
      inverse: function (t) {
        ...
        if (this.sphere) {
          ...
          switch (
            ...
            case this.EQUIT:
              (i = Math.abs(M) <= it ? 0 : Math.asin((l * u) / M)),
                (o *= u),
                (l = c * M);
              break;
            case this.OBLIQ:
        ...
        if (((a = n * Math.sin(e)), this.sphere))
          Math.abs(e) <= it
            ...
            : ((s = (this.a * Math.sin(a)) / Math.tan(e)),
              (i =
                this.a *
                (_s(e - this.lat0) + (1 - Math.cos(a)) / Math.tan(e))));
          ...
          ? Math.abs(this.sin_p12 - 1) <= it
            ...
            : ((_ = this.sin_p12 * k + this.cos_p12 * q * Math.cos(N)),
              ...
              (t.y =
                ...
                this.a *
                  d *
                  (this.cos_p12 * k - this.sin_p12 * q * Math.cos(N))),
              t)
          : ((s = fs(this.es)),
            (i = ms(this.es)),
            (a = ps(this.es)),
            ...
            Math.abs(this.sin_p12 - 1) <= it
              ...
              : ((r = k / q),
                ...
                (M = Math.atan(
                  (1 - this.es) * r + (this.es * o * this.sin_p12) / (l * q)
                )),
                (c = Math.atan2(
                  Math.sin(N),
        ...
        return (
          ...
          Math.abs(this.sin_p12 - 1) <= it
            ...
            : ((s = Math.sqrt(t.x * t.x + t.y * t.y)),
              ...
              (x = (-_ * _) / (1 - this.es)),
              (v =
                (3 * this.es * (1 - x) * this.sin_p12 * this.cos_p12 * d) /
                (1 - this.es)),
              (g = s / m),
              (b =
                g -
              ...
              (e = dt(
                this.long0 +
                  Math.asin((Math.sin(y) * Math.sin(b)) / Math.cos(p))
              )),
              (A = Math.sin(p)),
              (n = Math.atan2(
    ...
    Hs = {
      ...
      forward: function (t) {
        ...
        return (
          (n = Math.atan(
            (12 / rt) * (a + Math.acos(Math.sin(a) * Math.cos(et)) - Y)
          )),
          (e = Math.sqrt(
            (1 - Math.cos(h)) /
      ...
      inverse: function (t) {
        ...
        if (0 !== this.es) {
          ...
          (p = M.phi < 0 ? 1 : 0),
            ...
            (M.phi = Math.atan(
              Math.sqrt(this.a * this.a - d * d) / (this.one_minus_f * d)
            )),
            p && (M.phi = -M.phi);
        }
